...
def start_gzserver(context, *args, **kwargs):  
    ...
    #world_name = 'urjc_excavation_world'
...
def generate_launch_description():
    moveit_config = MoveItConfigsBuilder("simple_rover", package_name="simple_rover_moveit_config").to_moveit_configs() ##This was commented
    ...
    pkg_path = get_package_share_directory('simple_rover_description')
    ...
    model_path = get_model_paths(['simple_rover_description'])

    robot_description_launcher = IncludeLaunchDescription(
        PathJoinSubstitution(
            [FindPackageShare("simple_rover_moveit_config"), "launch", "rsp.launch.py"]
        )
    )
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare("simple_rover_description"), "rviz", "camera_rviz.rviz"]
    )
    ...
    twist_stamped = Node(
        ...
        remappings={('cmd_vel_out', '/rover_base_control/cmd_vel'), # /robot_base_control/cmd_vel'),
                    ('cmd_vel_in', '/cmd_vel')},
    )
